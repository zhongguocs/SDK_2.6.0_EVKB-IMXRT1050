...
uint32_t imx_rand(void);
#define LWIP_RAND() imx_rand()
...
#define DNS_LOCAL_HOSTLIST_INIT                                           \
     {DNS_LOCAL_HOSTLIST_ELEM("api.edgescale.org",                        \
                              IPADDR4_INIT_BYTES(34, 216, 247, 21)),      \
      DNS_LOCAL_HOSTLIST_ELEM("int.msg.edgescale.org",                    \
                              IPADDR4_INIT_BYTES(34, 216, 247, 21)),      \
      DNS_LOCAL_HOSTLIST_ELEM("int.e-est.edgescale.org",                  \
                              IPADDR4_INIT_BYTES(34, 216, 247, 21))}
#endif
